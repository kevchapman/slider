;(function($){
	...
	function Slider(ele,opts){
		...
		this.btnNext = this.ele.find(o.next);
		this.btnPrev = this.ele.find(o.prev);
	...
	Slider.prototype = {
		...
		layout:function(){
			...
			if(this.opts.extendLayout){ this.opts.extendLayout(); }
		},
		getIndex:function(){
		...
		setBtnStatus:function(){
			if( this.index === 0 ){ this.btnPrev.addClass('disabled');this.btnNext.removeClass('disabled'); if(this.total === 1){this.btnNext.addClass('disabled');} }
			else if(this.index >= this.total -1 ){ this.btnNext.addClass('disabled');this.btnPrev.removeClass('disabled'); }
			else { this.btnPrev.add(this.btnNext).removeClass('disabled'); }
		},
